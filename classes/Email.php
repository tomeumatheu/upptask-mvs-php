...
class Email {
    ...
    public function enviarConfirmacion(){
        ...
        //.= concatenar en php
        //Presiona  aqui y en el desployement debes colocar el dominio, aqui ponemos el localhost
    ...
    public function enviarInstrucciones(){
        ...
        $contenido .= "<p>Presiona aquí: <a href='" . $_ENV['UPTASK_URL'] . "/reestablecer?token=" . $this->token . "'>Reestablecer Password</a></p>";
        $contenido .= "<p>Si tu no creaste esta cuenta, puedes ignorar este mensaje</p>";
        $contenido .= '</html>';
